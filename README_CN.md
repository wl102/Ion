...
基于 [XBOW validation-benchmarks](https://github.com/xbow-engineering/validation-benchmarks)（共 104 个真实 Web 安全靶场，覆盖 IDOR / SQLi / XSS / SSRF / RCE 等）的测评结果：
...
|---|---|
| **总通过率** | **95 / 104 = 91.3%** |
| 平均 token 消耗 | ~1,562K / benchmark |
| 平均完成耗时 | ~9.3 min / benchmark |
