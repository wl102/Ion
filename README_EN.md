...
> 🌐 **Languages**: **English (current)** · [简体中文](./README.md)
...
- [ ] **Benchmarks** — wire up [Xbow validation-benchmarks](https://github.com/xbow-engineering/validation-benchmarks) and establish a regression baseline
...
[Xbow validation-benchmarks](https://github.com/xbow-engineering/validation-benchmarks) — integration in progress.
